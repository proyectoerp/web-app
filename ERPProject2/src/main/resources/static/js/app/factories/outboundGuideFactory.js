app.factory('outboundGuideFactory', function($http) {
	/*
	var outboundGuides = [
	...
	*/
	var factory = {};
	factory.getOutboundGuides = function(outboundGuides, callback) {
		$http.get('/erp/guiaSalida', {}).
		then(function(response) {
			$.each(response.data._embedded.guiaSalida, function(index, value) {
				outboundGuides.push({
					id: value.codigo,
	...
	factory.searchOutboundGuides = function(outboundGuide) {
